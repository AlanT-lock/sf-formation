...
export default function NewFormateurPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success(data.message || "Formateur créé");
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Identifiant de connexion modifiable (utile si deux formateurs ont le même nom)
          </p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-slate-500">
              Suggestion : <span className="font-mono">{suggestion || "—"}</span>. Modifiable pour distinguer deux formateurs (ex. jean.dupont2).
            </p>
